...
class ClaudeOrchestrator:
    ...
    def check_claude_auth(self):
        ...
        print("🔐 Claude Code 인증 상태 확인 중...")
        
        try:
            # Claude Code가 설치되어 있고 인증되어 있는지 확인
            ...
            if result.returncode == 0:
                ...
                print("터미널에서 'claude'를 실행하여 먼저 로그인하세요")
                exit(1)
                
        except Exception as e:
            print(f"❌ Claude Code가 설치되지 않았습니다: {e}")
    ...
    def get_default_plan(self) -> Dict:
        ...
        return {
            "tasks": [
                {
                    "id": "tmux-enhance",
                    "name": "Tmux 자동화 시스템 개선",
                    "description": "기존 tmux 자동화 시스템에 자동 응답 기능 추가 및 모니터링 강화",
                    "dependencies": [],
                    "priority": 1
                },
                {
                    "id": "training-programs",
                    "name": "트레이닝 프로그램 기능 완성",
                    "description": "SquashTrainingApp의 4주/12주/시즌 프로그램 UI 및 스케줄링 완성",
                    "dependencies": [],
                    "priority": 1
                },
                {
                    "id": "integration-test",
                    "name": "통합 테스트 시스템",
                    "description": "모든 기능에 대한 자동화된 통합 테스트 작성",
                    "dependencies": ["tmux-enhance", "training-programs"],
                    "priority": 2
                }
            ]
        }
...
if __name__ == "__main__":
    ...
    project = """
    SquashTrainingApp 개발 완성 및 자동화:
    - Tmux 자동화 시스템에 자동 응답 기능 추가
    - 트레이닝 프로그램 기능 (4주/12주/시즌) 완성
    - 전체 시스템 통합 테스트
    - 50회 이상 자동 빌드/테스트 사이클 실행
    """
